...
enum opt_code
{
  ...
  OPT_mcx16 = 1248,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1249,            /* -mdispatch-scheduler */
  OPT_mdll = 1250,                           /* -mdll */
  ...
  OPT_mhard_float = 1267,                    /* -mhard-float */
  OPT_mhle = 1268,                           /* -mhle */
  OPT_miamcu = 1269,                         /* -miamcu */
  OPT_mieee_fp = 1270,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1271,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1272,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1273,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1274,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1275,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1276, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1277,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1278,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1279,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1280,                /* -mlong-double-80 */
  OPT_mlwp = 1281,                           /* -mlwp */
  OPT_mlzcnt = 1282,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1283,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1284,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1285,                  /* -mmitigate-rop */
  OPT_mmmx = 1286,                           /* -mmmx */
  OPT_mmovbe = 1287,                         /* -mmovbe */
  OPT_mmovdir64b = 1288,                     /* -mmovdir64b */
  OPT_mmovdiri = 1289,                       /* -mmovdiri */
  OPT_mmpx = 1290,                           /* -mmpx */
  OPT_mms_bitfields = 1291,                  /* -mms-bitfields */
  OPT_mmwaitx = 1292,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1293,            /* -mno-align-stringops */
  OPT_mno_default = 1294,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1295,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1296,                  /* -mno-push-args */
  OPT_mno_red_zone = 1297,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1298,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1299,             /* -mnop-fun-dllimport */
  ...
  OPT_mpe_aligned_commons = 1308,            /* -mpe-aligned-commons */
  OPT_mpku = 1309,                           /* -mpku */
  ...
  OPT_municode = 1358,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1359,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1360,                          /* -mvaes */
  OPT_mveclibabi_ = 1361,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1362,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1363,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1364,                    /* -mvzeroupper */
  OPT_mwbnoinvd = 1365,                      /* -mwbnoinvd */
  OPT_mwin32 = 1366,                         /* -mwin32 */
  OPT_mwindows = 1367,                       /* -mwindows */
  OPT_mx32 = 1368,                           /* -mx32 */
  OPT_mxop = 1369,                           /* -mxop */
  OPT_mxsave = 1370,                         /* -mxsave */
  OPT_mxsavec = 1371,                        /* -mxsavec */
  OPT_mxsaveopt = 1372,                      /* -mxsaveopt */
  OPT_mxsaves = 1373,                        /* -mxsaves */
  OPT_n = 1374,                              /* -n */
  OPT_no_canonical_prefixes = 1375,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1376,              /* -no-integrated-cpp */
  OPT_no_pie = 1377,                         /* -no-pie */
  OPT_no_pthread = 1378,                     /* -no-pthread */
  OPT_nocpp = 1379,                          /* -nocpp */
  OPT_nodefaultlibs = 1380,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1381,                   /* -nostartfiles */
  OPT_nostdinc = 1382,                       /* -nostdinc */
  OPT_nostdinc__ = 1383,                     /* -nostdinc++ */
  OPT_nostdlib = 1384,                       /* -nostdlib */
  OPT_o = 1385,                              /* -o */
  OPT_p = 1386,                              /* -p */
  OPT_pass_exit_codes = 1387,                /* -pass-exit-codes */
  /* OPT_pedantic = 1388, */                 /* -pedantic */
  OPT_pedantic_errors = 1389,                /* -pedantic-errors */
  OPT_pg = 1390,                             /* -pg */
  OPT_pie = 1391,                            /* -pie */
  OPT_pipe = 1392,                           /* -pipe */
  OPT_posix = 1393,                          /* -posix */
  OPT_print_file_name_ = 1394,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1395,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1396,          /* -print-multi-directory */
  OPT_print_multi_lib = 1397,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1398,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1399,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1400,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1401,               /* -print-prog-name= */
  OPT_print_search_dirs = 1402,              /* -print-search-dirs */
  OPT_print_sysroot = 1403,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1404,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1405,                        /* -pthread */
  ...
  /* OPT_specs = 1414, */                    /* -specs */
  OPT_specs_ = 1415,                         /* -specs= */
  OPT_static = 1416,                         /* -static */
  OPT_static_libasan = 1417,                 /* -static-libasan */
  OPT_static_libgcc = 1418,                  /* -static-libgcc */
  OPT_static_libgfortran = 1419,             /* -static-libgfortran */
  OPT_static_libgo = 1420,                   /* -static-libgo */
  OPT_static_liblsan = 1421,                 /* -static-liblsan */
  OPT_static_libmpx = 1422,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1423,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1424,               /* -static-libstdc++ */
  OPT_static_libtsan = 1425,                 /* -static-libtsan */
  OPT_static_libubsan = 1426,                /* -static-libubsan */
  OPT_static_pie = 1427,                     /* -static-pie */
  /* OPT_std_c__03 = 1428, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1429, */                /* -std=c++0x */
  OPT_std_c__11 = 1430,                      /* -std=c++11 */
  OPT_std_c__14 = 1431,                      /* -std=c++14 */
  OPT_std_c__17 = 1432,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1433, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1434, */                /* -std=c++1z */
  OPT_std_c__2a = 1435,                      /* -std=c++2a */
  OPT_std_c__98 = 1436,                      /* -std=c++98 */
  OPT_std_c11 = 1437,                        /* -std=c11 */
  OPT_std_c17 = 1438,                        /* -std=c17 */
  /* OPT_std_c18 = 1439, */                  /* -std=c18 */
  ...
  OPT_std_f2018 = 1448,                      /* -std=f2018 */
  OPT_std_f95 = 1449,                        /* -std=f95 */
  OPT_std_gnu = 1450,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1451, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1452, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1453,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1454,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1455,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1456, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1457, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1458,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1459,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1460,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1461,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1462, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1463, */                /* -std=gnu1x */
  ...
  OPT_symbolic = 1476,                       /* -symbolic */
  OPT_t = 1477,                              /* -t */
  OPT_time = 1478,                           /* -time */
  OPT_time_ = 1479,                          /* -time= */
  OPT_traditional = 1480,                    /* -traditional */
  OPT_traditional_cpp = 1481,                /* -traditional-cpp */
  OPT_trigraphs = 1482,                      /* -trigraphs */
  OPT_u = 1483,                              /* -u */
  OPT_undef = 1484,                          /* -undef */
  OPT_v = 1485,                              /* -v */
  OPT_version = 1486,                        /* -version */
  OPT_w = 1487,                              /* -w */
  OPT_wrapper = 1488,                        /* -wrapper */
  OPT_x = 1489,                              /* -x */
  OPT_z = 1490,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
